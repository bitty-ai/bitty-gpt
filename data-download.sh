...
if [ ! -f "$TRAIN_FILE" ]; then
    ...
    wget -4  https://huggingface.co/datasets/roneneldan/TinyStories/resolve/main/TinyStoriesV2-GPT4-train.txt
else
...
if [ ! -f "$VALID_FILE" ]; then
    ...
    wget -4 https://huggingface.co/datasets/roneneldan/TinyStories/resolve/main/TinyStoriesV2-GPT4-valid.txt
else
